        ...
        <Grid className='main' sx={{backgroundColor:'white', marginTop:'40px'}} container spacing={0}>
            ...
            <Grid container spacing={0}>
                ...
                <CustomGridLabel
                        ...
                        xs={12} sm={5}
                    >
                        <p>Jenis Status Kerja <span>:</span></p>
                    </CustomGridLabel>
                    <Grid item xs={12} sm={7}>
                        <CustomFormControlDrop2 variant='outlined'>
                            
                            <InputLabel id="demo-simple-select-helper-label">Jenis Status Kerja</InputLabel>
                            <CustomSelect
                                MenuProps={{
                                    PaperProps: {
                                    style: {
                                ...
                                value={selectedOption1}
                                displayEmpty={isLargeScreen}
                                label={isLargeScreen ? "" : 'Jenis Status Kerja'}
                                onChange={handleOption1Change}
                                disableScrollLock={true}
                                >
                                <MenuItem disabled value="" >
                    ...
                    <Grid sx={{height:'40px'}} item xs={12} sm={7}>
