...
function DataJabatanNon() {

  return (
    <PageAreaContainer >
        <Box style={{marginBottom:'20px'}}>
            <h1>PENCARIAN DATA KARYAWAN PADA JABATAN NON AKTIF</h1>
        </Box>
        ...
        <Box sx={{marginTop:'20px'}}>
            <h3>DATA KARYAWAN PADA JABATAN YANG TIDAK AKTIF DI KANTOR REGIONAL I MEDAN 20004</h3>
