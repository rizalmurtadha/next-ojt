...
function DataBagianNon() {
  ...
  return (
    <PageAreaContainer >
        <h1>PENCARIAN DATA KARYAWAN PADA BAGIAN NON AKTIF</h1>
        ...
        <Box sx={{ marginTop:'40px', marginBottom:'20px'}}>
            <h3>DATA KARYAWAN PADA BAGIAN YANG TIDAK AKTIF DI KANTOR REGIONAL I MEDAN 20004</h3>
