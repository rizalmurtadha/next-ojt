...
const rows = [
    ...
    { no: 2, nama: 'Rizal', nippos: "999123456", kantor: "KCU JAKARTACENTRUM", nopen: "10000" ,wilpos:'02', statusKerja:'Aktif'},
    { no: 3, nama: 'Rizal', nippos: "999123456", kantor: "KCU JAKARTACENTRUM", nopen: "10000" ,wilpos:'02', statusKerja:'Aktif'},
  ];
...
function LaporanPerKantor() {
  ...
  return (
    <PageAreaContainer >
        <h1>LAPORAN TMT CBS, MPP DAN PENSIUN PER KANTOR</h1>
        <Grid className='main' sx={{backgroundColor:'white'}} container spacing={0}>
            ...
            <Grid container spacing={0}>
                ...
                <CustomGridLabel
                    ...
                    xs={12} sm={4}
                >
                    <p>Scope Bagian <span>:</span></p>
                </CustomGridLabel>
                <Grid item xs={12} sm={8}>
                    <CustomFormControlDrop2>
                        
                        <InputLabel id="demo-simple-select-helper-label">Scope Bagian</InputLabel>
                        <CustomSelect
                            MenuProps={{
                                PaperProps: {
                                style: {
                            ...
                            displayEmpty={isLargeScreen}
                            label={isLargeScreen ? "" : 'Scope Bagian*'}
...
export default LaporanPerKantor